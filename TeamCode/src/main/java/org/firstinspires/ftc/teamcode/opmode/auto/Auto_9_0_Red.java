...
public class Auto_9_0_Red extends LinearOpMode {
    ...
    public static double shoot0Heading =  180 - 145;
    ...
    public static double shoot1Heading = 180 - 145;
    ...
    public static double shoot2Heading = 180 - 145;
    ...
    public static double shoot3Heading = 180 - 145;

    public static double move3X = 144 - 70;
