...
public class BilordaHouston extends OpMode {
    ...
    private static final double FAR_SHOOTER_P = 16;  // Вставьте значение P для FarShooter
    private static final double FAR_SHOOTER_F = 2.5;  // Вставьте значение F для FarShooter

    // PID параметры для sredniyshooter (dpad_right)
    private static final double SREDNIY_SHOOTER_P = 9;  // Вставьте значение P для sredniyshooter
    private static final double SREDNIY_SHOOTER_F = 4;  // Вставьте значение F для sredniyshooter

    // PID параметры для smallshooter (dpad_down)
    private static final double SMALL_SHOOTER_P = 9;  // Вставьте значение P для smallshooter
    private static final double SMALL_SHOOTER_F = 2;  // Вставьте значение F для smallshooter

    // PID параметры для sort
    private static final double SORT_P = 9;  //0 Значение P для sort
    private static final double SORT_F = 4;  //0 Значение F для sort
    ...
    private static final double FAR_SHOOTER_VELOCITY = 1450; // Настройте скорость для FarShooter (dpad_up)
    private static final double SREDNIY_SHOOTER_VELOCITY = 1450; // Настройте скорость для sredniyshooter (dpad_right)
    private static final double SMALL_SHOOTER_VELOCITY = 1450; // Настройте скорость для smallshooter (dpad_down)
