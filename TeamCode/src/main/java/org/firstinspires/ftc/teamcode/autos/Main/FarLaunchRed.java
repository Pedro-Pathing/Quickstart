...
@Autonomous(name = "FarLaunchRed", group = "Autonomous")
@Configurable // Panels
public class FarLaunchRed extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(81.208, 9.647, Math.toRadians(90)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Path1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(81.208, 9.647), new Pose(72.263, 71.562))
                    )
