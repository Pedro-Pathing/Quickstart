...
public class AutoExample extends OpMode {
    ...
    private final Pose pickup1Pose = new Pose(40, 40, Math.toRadians(180)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup2Pose = new Pose(0, 40, Math.toRadians(270)); // Middle (Second Set) of Artifacts from the Spike Mark.
