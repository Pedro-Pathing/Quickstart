...
@Configurable // Panels
public class GoalBlue extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(22.275, 124.531, Math.toRadians(323)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Path1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(22.275, 124.531), new Pose(72.263, 71.562))
                    )
