...
// Goal start
@Autonomous
public class AANewJeffreyAuto extends NextFTCOpMode {

    public static Pose endPose;


    public AANewJeffreyAuto() {
        addComponents(
    ...
    public static final Pose startPoseRed = new Pose(123, 123, Math.toRadians(37)); // Start Pose of our robot.
