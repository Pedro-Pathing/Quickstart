...
public class TheGoodAutoRed extends NextFTCOpMode {
    ...
    private static final Pose startPose = new Pose(87, 8, Math.toRadians(270)); // Start Pose of our robot.
    public static final Pose scorePose = new Pose(73, 70, Math.toRadians(225)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
