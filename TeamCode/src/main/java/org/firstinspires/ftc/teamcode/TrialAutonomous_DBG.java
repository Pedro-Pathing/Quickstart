...
@Autonomous
public class TrialAutonomous_DBG extends OpMode {
    ...
    private void InitializePoseValues() {
        ...
        if (gamepad1.y) {
            ...
            shootPose = new Pose(49.44645799011532, 97.36738056013179, Math.toRadians(138));
            ...
            launchPose1 = new Pose(49.44645799011532, 97.36738056013179, Math.toRadians(138));
            ...
            launchPose2 = new Pose(49.44645799011532, 97.36738056013179, Math.toRadians(132));
            ...
            launchPose3 = new Pose(49.44645799011532, 97.36738056013179, Math.toRadians(132));
        ...
        if (gamepad1.b) {
            ...
            preloadPose = new Pose(
                    96.35555555555555, 95.11111111111111, Math.toRadians(0));

            intakePose = new Pose(
                    136.88888888888889, 95.46666666666667, Math.toRadians(0));

            launchPose1 = new Pose(
                    96.55354200988468, 95.36738056013179, Math.toRadians(48));

            preloadPose2 = new Pose(
                    86.39999999999999, 71.82222222222222, Math.toRadians(0));

            intakePose2 = new Pose(
                    136.17777777777778, 72, Math.toRadians(0));

            launchPose2 = new Pose(
                    96.55354200988468, 95.36738056013179, Math.toRadians(48));

            preloadPose3 = new Pose(
                    84.08888888888889, 47.28888888888889, Math.toRadians(0));

            intakePose3 = new Pose(
                    143.2888888888889, 47.28888888888889, Math.toRadians(0));

            launchPose3 = new Pose(
                    96.55354200988468, 95.36738056013179, Math.toRadians(48));

            finishPose = new Pose(
                    109.15555555555555, 84.08888888888889, Math.toRadians(0));
        ...
        if (gamepad1.x) {
            x = true;
            startPose = new Pose(65.6, 8.000000000000004, Math.toRadians(90));
            shootPose = new Pose(71.82222222222222, 23.28888888888889, Math.toRadians(110));
            preloadPose = new Pose(41.06666666666667, 9.422222222222222, Math.toRadians(180));
            buildPaths();
            follower.setPose(startPose);
            pathsBuilt = true;
    ...
    private void statePathUpdate() {
        ...
        if (x ^ a) {
            shooterVelocity = -1990;
        }
        else {
            shooterVelocity = -1150;
        }
