...
@Autonomous(name = "Red Alliance Big Launch Auto", group = "Autonomous")
public class RedAllianceBigLaunchAuto extends OpMode {
    ...
    private final Pose shootPose = new Pose(108, 108, Math.toRadians(45));
