...
final class DecodedBitStreamParser {
                ...
                switch (modeForBits) {
                    ...
                    default:
                        ...
                        switch (modeForBits) {
                            ...
                            case ALPHANUMERIC:
                                mode = modeForBits;
                                decodeAlphanumericSegment(bitSource, sb, bits5, r152);
                                r15 = r152;
                                break;
                            case BYTE:
                                mode = modeForBits;
    ...
    private static void decodeKanjiSegment(BitSource bitSource, StringBuilder sb, int i) throws FormatException {
        ...
        while (i > 0) {
            int bits = bitSource.readBits(13);
            int i4 = (bits % ByteCodes.checkcast) | ((bits / ByteCodes.checkcast) << 8);
            if (i4 < 7936) {
                i2 = 33088;
            } else {
                i2 = 49472;
    ...
    private static int parseECIValue(BitSource bits) throws FormatException {
        ...
        if ((firstByte & ByteCodes.checkcast) == 128) {
            int secondByte = bits.readBits(8);
            return ((firstByte & 63) << 8) | secondByte;
        }
        if ((firstByte & UsbConstants.USB_CLASS_WIRELESS_CONTROLLER) == 192) {
