...
class FocusControlAccess extends Access {
    ...
    private FocusControl checkFocusControl(Object focusControlArg) {
        return (FocusControl) checkArg(focusControlArg, FocusControl.class, "focusControl");
    }

    private FocusControl.Mode checkMode(String modeString) {
        return (FocusControl.Mode) checkArg(modeString, FocusControl.Mode.class, "Mode");
    }
    ...
    public boolean setMode(Object focusControlArg, String modeString) {
        try {
            ...
            FocusControl focusControl = checkFocusControl(focusControlArg);
            FocusControl.Mode mode = checkMode(modeString);
