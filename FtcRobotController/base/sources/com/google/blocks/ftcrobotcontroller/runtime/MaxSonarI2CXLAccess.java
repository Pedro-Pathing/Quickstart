...
class MaxSonarI2CXLAccess extends HardwareAccess<MaxSonarI2CXL> {
    ...
    public double getDistanceSync(String distanceUnitString) {
        try {
            ...
            if (distanceUnit != null) {
                return this.maxSonarI2CXL.getDistanceSync(distanceUnit);
            }
            endBlockExecution();
    ...
    public double getDistanceSync_withDelay(int sonarPropagationDelayMs, String distanceUnitString) {
        try {
            ...
            DistanceUnit distanceUnit = (DistanceUnit) checkArg(distanceUnitString, DistanceUnit.class, "distanceUnit");
            if (distanceUnit != null) {
                return this.maxSonarI2CXL.getDistanceSync(sonarPropagationDelayMs, distanceUnit);
            }
            endBlockExecution();
            return LynxServoController.apiPositionFirst;
        } catch (Throwable e) {
    ...
    public double getDistanceAsync(String distanceUnitString) {
        try {
            ...
            DistanceUnit distanceUnit = (DistanceUnit) checkArg(distanceUnitString, DistanceUnit.class, "distanceUnit");
            if (distanceUnit != null) {
                return this.maxSonarI2CXL.getDistanceAsync(distanceUnit);
            }
            endBlockExecution();
            return LynxServoController.apiPositionFirst;
        } catch (Throwable e) {
    ...
    public double getDistanceAsync_withDelay(int sonarPropagationDelayMs, String distanceUnitString) {
        try {
            ...
            DistanceUnit distanceUnit = (DistanceUnit) checkArg(distanceUnitString, DistanceUnit.class, "distanceUnit");
            if (distanceUnit != null) {
                return this.maxSonarI2CXL.getDistanceAsync(sonarPropagationDelayMs, distanceUnit);
            }
            endBlockExecution();
            return LynxServoController.apiPositionFirst;
        } catch (Throwable e) {
    ...
    public void setI2cAddress7Bit(int i2cAddr7Bit) {
        try {
            ...
            this.maxSonarI2CXL.setI2cAddress(I2cAddr.create7bit(i2cAddr7Bit));
        } catch (Throwable e) {
            try {
                this.blocksOpMode.handleFatalException(e);
                throw new AssertionError("impossible", e);
    ...
    public void setI2cAddress8Bit(int i2cAddr8Bit) {
        try {
            ...
            this.maxSonarI2CXL.setI2cAddress(I2cAddr.create8bit(i2cAddr8Bit));
        } catch (Throwable e) {
            try {
                this.blocksOpMode.handleFatalException(e);
                throw new AssertionError("impossible", e);
